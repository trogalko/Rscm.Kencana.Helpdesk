...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <ext:Viewport runat="server" Layout="BorderLayout">
        <Items>
            <ext:Panel runat="server" ID="pnlTask" Title="REQUESTS" Height="300" Region="North">
                <Items>
                    <ext:GridPanel runat="server" ID="grdTask">
                        <Store>
                            <ext:Store ID="storeTask" runat="server" AutoLoad="true" OnReadData="storeTask_ReadData">
                                <Proxy>
                                    <ext:PageProxy />
                                </Proxy>
                                <Model>
            ...
            <ext:Panel runat="server" ID="pnlDetails" Height="180" Region="Center">
                <Items>
                    <ext:Panel runat="server">
                        <Items>
                            <ext:TextArea runat="server" Html="<p><b>Aku seorang kapiten</b></p><p>Ciyus lohhh</p>dfdfdfdfdfdfd"></ext:TextArea>
                        </Items>
                    </ext:Panel>
                    <ext:Panel runat="server">
                    </ext:Panel>
