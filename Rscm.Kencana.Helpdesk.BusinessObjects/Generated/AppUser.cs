...
Date Generated       : 5/17/2013 2:52:11 PM
===============================================================================
*/
...
namespace Rscm.Kencana.Helpdesk.BusinessObjects
{
	...
	abstract public partial class esAppUser : esEntity
	{
		...
		virtual public System.Boolean? IsActive
		{
			get
			{
				return base.GetSystemBoolean(AppUserMetadata.ColumnNames.IsActive);
			}
			
			set
			{
				if(base.SetSystemBoolean(AppUserMetadata.ColumnNames.IsActive, value))
				{
					OnPropertyChanged(AppUserMetadata.PropertyNames.IsActive);
				}
			}
		}		
	...
	abstract public partial class esAppUserQuery : esDynamicQuery
	{
		...
		{
			get { return new esQueryItem(this, AppUserMetadata.ColumnNames.IsActive, esSystemType.Boolean); }
		} 
	...
	public partial class AppUserMetadata : esMetadata, IMetadata
	{
		...
		protected AppUserMetadata()
		{
			...
			c = new esColumnMetadata(AppUserMetadata.ColumnNames.IsActive, 8, typeof(System.Boolean), esSystemType.Boolean);
			c.PropertyName = AppUserMetadata.PropertyNames.IsActive;
			c.HasDefault = true;
			c.Default = @"((1))";
			m_columns.Add(c);
